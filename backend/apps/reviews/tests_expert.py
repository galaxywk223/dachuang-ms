...
class ExpertGroupTestCase(TestCase):
    def setUp(self):
        ...
        # Create Admin
        self.admin = User.objects.create_user(username='admin', password='password', role='LEVEL2_ADMIN', real_name='Admin', employee_id='9999', college='CS')

        # Create Experts
        self.expert1 = User.objects.create_user(username='expert1', password='password', role='EXPERT', real_name='Expert1', employee_id='E001')
        self.expert2 = User.objects.create_user(username='expert2', password='password', role='EXPERT', real_name='Expert2', employee_id='E002')
