...
class Project(models.Model):
    ...
    class PublishStatus(models.TextChoices):
        NOT_READY = "NOT_READY", "未进入发布"
        RECOMMENDED = "RECOMMENDED", "学院已推荐"
        CONFIRMED = "CONFIRMED", "学校已确认"
    ...
    recommendation_rank = models.PositiveIntegerField(
        null=True, blank=True, verbose_name="学院推荐排序"
    )
    ...
    recommendation_comment = models.TextField(blank=True, verbose_name="学院推荐意见")
    ...
    publish_status = models.CharField(
        ...
        default=PublishStatus.NOT_READY,
        verbose_name="发布状态",
    )
