...
export function getPublicationCenter(
  params?: Record<string, unknown>
): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/publication-center/",
    method: "get",
    params,
  });
}

export function savePublicationRecommendations(data: {
  items: Record<string, unknown>[];
}): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/publication/recommend/",
    method: "post",
    data,
  });
}

export function confirmPublicationResults(data: {
  items: Record<string, unknown>[];
}): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/publication/confirm/",
    method: "post",
    data,
  });
}

export function publishEstablishmentResults(data: {
  project_ids: number[];
}): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/publication/publish/",
    method: "post",
    data,
  });
}

export function exportPublicationResults(): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/publication/export/",
    method: "get",
    responseType: "blob",
  });
}

export function exportPublicationResultsTask(): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/publication/export-task/",
    method: "post",
  });
}

export function batchExportDocsTask(data: { ids: number[] }): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/batch-export-doc-task/",
    method: "post",
    data,
  });
}

export function batchExportCertificatesTask(data: {
  ids: number[];
}): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/batch-certificates-task/",
    method: "post",
    data,
  });
}

export function batchExportNoticesTask(data: { ids: number[] }): Promise<unknown> {
  return request({
    url: "/projects/admin/manage/batch-establishment-notice-task/",
    method: "post",
    data,
  });
}
...
export function getManagementDashboard(
  ...
  return request({
    url: "/projects/admin/manage/dashboard/",
    method: "get",
    params,
  });
}

export function getProjectTimeline(id: number): Promise<unknown> {
  return request({
    url: `/projects/admin/manage/${id}/timeline/`,
    method: "get",
  });
}
