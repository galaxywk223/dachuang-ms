...
export function downloadProjectFile(id: number, field: string): Promise<unknown> {
  return request({
    url: `/projects/${id}/files/${field}/download/`,
    method: "get",
    responseType: "blob",
  });
}

export function downloadProjectAchievementAttachment(
  id: number
): Promise<unknown> {
  return request({
    url: `/projects/achievements/${id}/download/`,
    method: "get",
    responseType: "blob",
  });
}
 ...
 * 下载经费凭证文件
 */
export function downloadProjectExpenditureProof(id: number): Promise<unknown> {
  return request({
    url: `/projects/expenditures/${id}/download/`,
    method: "get",
    responseType: "blob",
  });
}
