        ...
        <el-form :inline="true" :model="filters" class="filter-form">
          ...
          <el-form-item label="学院">
            <el-select
              ...
              :placeholder="lockToCurrentCollege ? '本院' : '选择学院'"
              :disabled="lockToCurrentCollege"
              clearable
              filterable
              style="width: 180px"
            >
...
import { useExpertManagement } from "@/views/admin/level1/users/hooks/useExpertManagement";

const props = withDefaults(
  defineProps<{
    title?: string;
    lockToCurrentCollege?: boolean;
  }>(),
  {
    title: "专家库管理",
    lockToCurrentCollege: false,
  }
);
...
const {
  ...
  lockedCollege: () => (props.lockToCurrentCollege ? currentCollege.value : ""),
});

watch(currentCollege, () => {
  if (props.lockToCurrentCollege) {
...
<style scoped lang="scss" src="./ExpertManagement.scss"></style>
