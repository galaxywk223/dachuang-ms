...
export const adminRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/views/admin/shared/ExpertManagement.vue"),
        props: { title: "专家库管理", lockToCurrentCollege: false },
        meta: { title: "专家库管理" },
      },
      {
        path: "expert/groups",
      ...
      {
        path: "publication",
        name: "level1-publication-center",
        component: () => import("@/views/admin/shared/PublicationCenter.vue"),
        meta: { title: "立项发布中心" },
      },
      {
        path: "data-center",
        name: "level1-data-center",
        component: () => import("@/views/admin/level1/data/DataCenter.vue"),
        meta: { title: "数据导入中心" },
      },
      {
        path: "tasks",
        name: "level1-task-center",
        component: () => import("@/views/admin/shared/TaskCenter.vue"),
        meta: { title: "任务中心" },
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import("@/views/admin/shared/ChangeReviewTable.vue"),
            props: {
              title: "项目变更审核",
